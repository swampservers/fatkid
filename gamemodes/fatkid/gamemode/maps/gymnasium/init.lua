...
return nil < nil < nil < nil < nil < nil < HEAD == nil == nil == nil > nil > nil > nil > nil > nil > nil > 62, hook.Add("MapSetup", "Gymnasium_PropFix", function()
    for k, v in next, ents.FindByModel("models/props_c17/lockers001a.mdl") do
        v:GetPhysicsObject():EnableMotion(false)
    end
end), hook.Add("MapSetup", "Gymnasium_Dodgeballs", function()
    for i = 1, 10 do
